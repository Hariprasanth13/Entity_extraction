...
#model = TextGenerationModel.from_pretrained("publishers/google/models/gemini-1.5-pro-001")

aiplatform.init(project="rntbci-digital-innovation-lab", location="us-central1")
endpoint = aiplatform.Endpoint(
        "projects/rntbci-digital-innovation-lab/locations/us-central1/endpoints/gemini-1.5-pro-001"
    )
...
# model_name = f"projects/{project_id}/locations/{location}/publishers/google/models/gemini-1.5-pro-001"
...
#         "document": {
#             "content": document1,
#             "mime_type": "application/pdf"  # Adjust the MIME type as needed
#         }
#     }
# ]
#   parameters = {
#     "temperature": 0,  # Adjusts the creativity of the model (0.0 - 1.0)
# }
        ...
        instances=[
            {
                ...
                # Add any other parameters supported by the Gemini API
...
#   )
  ...
  #responses  = model.predict(instances=instances,parameters=parameters)
